...
<body>
    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10">
            <div class="data-dokter bg-warning text-white mt-5 p-3 bordered">
                ...
                <table class="table">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Alamat <i class="fas fa-sort"></i></th>
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM datadokter_spesialis WHERE nama LIKE '%$keyword%' OR spesialis LIKE  '%$keyword%'";
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="edit-data-dokter.php?id=<?= $row['id'] ?>"><i class="fas fa-edit text-white bg-success p-2 rounded" data-bs-toggle="tooltip" title="Edit"></i></td>
                                <td><a href="hapus-data-dokter.php?id=<?= $row['id'] ?>"><i class="fas fa-trash-alt text-white bg-danger p-2 rounded" data-bs-toggle="tooltip" title="Hapus"></i></td>
                            <?php
