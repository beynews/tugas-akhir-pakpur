...
<body>
    ...
    <div class="row no-gutters mt-5">
        <div class="col-md-2 bg-dark mt-4  p-4 ">
        ...
        <div class="col-md-10">
            <div class="data-rawatjalan bg-warning text-white mt-5 p-3 bordered">
                ...
                <table class="table">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col">No Rawat <i class="fas fa-sort"></i> </th>
                            <th scope="col">Nama Pasien <i class="fas fa-sort"></i></th>
                            <th scope="col">Cara Masuk <i class="fas fa-sort"></i></th>
                            <th scope="col">Dokter Penanggung Jawab <i class="fas fa-sort"></i></th>
                            <th scope="col">Polikklinik <i class="fas fa-sort"></i></th>
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM laporan_rawatjalan WHERE norawat LIKE '%$keyword%' OR namapasien LIKE  '%$keyword%'";
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $row["caramasuk"] ?></td>
                                <td><?= $row["dokterpenanggungjawab"] ?></td>
                                <td><?= $row["polikklinik"] ?></td>
                                <td><?= $row["jenisbayar"] ?></td>
                                <td> <img src="gambar/<?= $gambar ?>" style="width: 50px;"></td>
                                <td><a href="edit-data-rawatjalan.php?id=<?= $row['id'] ?>"><i class="fas fa-edit text-white bg-success p-2 rounded" data-bs-toggle="tooltip" title="Edit"></i></td>
                                <td><a href="hapus-data-rawatjalan.php?id=<?= $row['id'] ?>"><i class="fas fa-trash-alt text-white bg-danger p-2 rounded" data-bs-toggle="tooltip" title="Hapus"></i></td>
                            <?php
